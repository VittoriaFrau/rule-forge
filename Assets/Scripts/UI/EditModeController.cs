        ...
        public void CreateAndPublishAction(string actionName)
        {
            ...
            switch (actionName)
            {
                ...
                case "Brightness":
                    ...
                    _ruleEngine.ExecuteAction(new Action(SelectedObject, "changes", "intensity", "to", lightValue ));
                    break;
                
                case "TurnOn":
                    _ruleEngine.ExecuteAction(new Action(SelectedObject, "turn light", ECABoolean.ON));
                    break;
                
                case "TurnOff":
                    _ruleEngine.ExecuteAction(new Action(SelectedObject, "turn light", ECABoolean.OFF));
                    break;
